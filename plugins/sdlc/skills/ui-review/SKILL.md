...
Read the [shared UI contract](../ui-kit/references/ui-workflow.md). This skill reports only; existing project policies and authorization still apply. It is not a general UX or aesthetic audit.

# Review UI Kit conformity
